...
const state = {
  ...
  auth: {
    ...
    clientID: 'b67a48a035af6d273ed9',   // 改成你在 https://github.com/settings/applications/new 新建的 OAuth application 的 Client ID
  ...
  gitHubUsername: 'geekyouth',  // 修改成你自己的 GitHub 账号
  copyright: '2014 - 2048',  // 修改成你自己的
  recordNumber: 'null',  // 修改成你自己的备案编号，如果没有备案的话就设置为 null
  repo: 'geekyouth/geekyouth.github.io',  // 记录 Issue 的仓库的全名「用户名/仓库名」
  ...
  thirdPartySite: [  // 配置你想在左上角展示的第三方站点信息
    {
      ...
      url: 'https://github.com/geekyouth/geekyouth.github.io'  // 第三方站点的 url
    },
    {
      img: 'static/img/git.png',
      url: 'https://gitee.com/geekyouth'
    }
